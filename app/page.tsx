  ...
  return (
    <div style={{ minHeight: '100vh', background: '#fff', color: '#222', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
      <div style={{ textAlign: 'center', padding: 16 }}>
        <div style={{ fontSize: 20, fontWeight: 'bold', marginBottom: 12, letterSpacing: 1 }}>eigyooo</div>
        <div style={{ marginBottom: 16, fontSize: 12, lineHeight: 1.5 }}>
          営業職のための匿名SNS<br />
          日々の頑張りや苦労、成功体験を気軽につぶやこう！
        </div>
        <div style={{ display: 'flex', gap: 8, justifyContent: 'center' }}>
          <a href="/login" style={{ padding: '6px 18px', background: '#f5f5f5', color: '#222', borderRadius: 6, fontSize: 12, textDecoration: 'none', fontWeight: 'bold', border: '1px solid #ccc' }}>ログイン</a>

              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 4, marginTop: 8, justifyContent: 'space-between' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                    ...
                    >
                      <svg width="14" height="14" viewBox="0 0 24 24" fill={likeStates[post.id]?.liked ? "#E89A9A" : "none"} stroke="#E89A9A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ display: 'block', verticalAlign: 'middle' }}>
